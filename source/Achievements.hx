...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Disabled Man on a Wheelchair",		"Beat Dave's Week with no misses!",				    'weekdave_nomiss',			false],
		["I BREAK MAH PHONE!! ",		"Beat Splitathon with no misses!",				'weeky_nomiss',			false],
		["The Finale is the friends we made along the way ",		"Beat Bambi's Week with no misses!",				'weekxxx_nomiss',			false],
		["Everything here is bonus ",	"Beat all the Bonus Songs and Joke Songs with no misses!",				'weekzzz_nomiss',			false],
	];
