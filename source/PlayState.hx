...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['IM GONNA BREAK MAH PHONE', 0.2], //From 0% to 19%
		['Bamballs says you suck bitch', 0.4], //From 20% to 39%
		['Bambi is not happy with this', 0.5], //From 40% to 49%
		['Bruh', 0.6], //From 50% to 59%
		['Eeeeh, ok!', 0.69], //From 60% to 68%
		['Nice, 69 lol', 0.7], //69%
		['Amazing!', 0.8], //From 70% to 79%
		['Cool', 0.9], //From 80% to 89%
		['dave moment', 1], //From 90% to 99%
		['Badass', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		if(PlayState.SONG.stage == null || PlayState.SONG.stage.length < 1) {
			switch (songName)
			{
				case 'house' | 'insanity' | 'old-insanity' | 'supernovae':
					curStage = 'davesYard';
				...
				case 'blocked' | 'corn-theft' | 'old-corn-theft':
					curStage = 'bambisFarm';
				case 'maze' | 'old-maze':
					curStage = 'bambisFarm-sunset';
				case 'splitathon' | 'mealie':
					curStage = 'bambisFarm-night';
				case 'cheating':
					curStage = 'green-void';
				case 'unfairness':
					curStage = 'glitchy-void';
				case 'bonus-song' | 'glitch':
					curStage = 'davesYard-night';
...
switch (curStage)
		{
			...
			case 'schoolEvil': //Week 6 - Thorns
				...
				var bg:BGSprite = new BGSprite('hills', -225, -125, 0.9, 0.9);
				...
				var bg:BGSprite = new BGSprite('gate', -200, -125, 0.9, 0.9);
				bg.setGraphicSize(Std.int(bg.width * 1.25));
				bg.updateHitbox();
				bg.antialiasing = true;
				...
				var bg:BGSprite = new BGSprite('grass', -225, -125, 0.9, 0.9);
				bg.setGraphicSize(Std.int(bg.width * 1.25));
				bg.updateHitbox();
				bg.antialiasing = true;
				bg.active = false;
	            ...
	            case '3dBruh': //Week Dave
				var bg:BGSprite = new BGSprite('redsky', -600, -200, 0.9, 0.9);
				bg.antialiasing = true;
				bg.scrollFactor.set(0.75, 0.75);
				bg.active = false;
				add(bg);
				...
				var bg:BGSprite = new BGSprite('orangey hills', -250, 200, 0.9, 0.9);
				bg.antialiasing = true;
				bg.scrollFactor.set(0.9, 0.7);
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('funfarmhouse', 150, 250, 0.9, 0.9);
				bg.antialiasing = true;
				bg.scrollFactor.set(1.1, 0.9);
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('grass lands', -400, 600, 0.9, 0.9);
				bg.antialiasing = true;
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('Cornys', -350, 325, 0.9, 0.9);
				bg.antialiasing = true;			
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('Cornys', 1050, 325, 0.9, 0.9);
				bg.antialiasing = true;
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('crazy fences', -350, 450, 0.9, 0.9);
				bg.antialiasing = true;
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('Sign', 0, 500, 0.9, 0.9);
				bg.antialiasing = true;
				bg.active = false;
				add(bg);

				case 'davesYard-night': //Week Dave at Night
				defaultCamZoom = 0.9;
				curStage = 'davesYard_night';
				var bg:BGSprite = new BGSprite('sky_night', -600, -200, 0.9, 0.9);
				bg.antialiasing = true;
				bg.scrollFactor.set(0.75, 0.75);
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('hills_night', -225, -125, 0.9, 0.9);
				bg.setGraphicSize(Std.int(bg.width * 1.25));
				bg.updateHitbox();
				bg.antialiasing = true;
				bg.scrollFactor.set(0.8, 0.8);
				...
				var bg:BGSprite = new BGSprite('gate_night', -225, -125, 0.9, 0.9);
				bg.setGraphicSize(Std.int(bg.width * 1.25));
				bg.updateHitbox();
				bg.antialiasing = true;
				bg.scrollFactor.set(0.9, 0.9);
				...
				var bg:BGSprite = new BGSprite('grass_night', -225, -125, 0.9, 0.9);
				bg.setGraphicSize(Std.int(bg.width * 1.25));
				bg.updateHitbox();
				bg.antialiasing = true;
				bg.active = false;
                ...
                case 'bambisFarm-night': //Week Splitathon
				var bg:BGSprite = new BGSprite('sky_night', -600, -200, 0.9, 0.9);
				bg.antialiasing = true;
				bg.scrollFactor.set(0.75, 0.75);
				bg.active = false;
				...
				var bg:BGSprite = new BGSprite('orangey hills_night', -250, 200, 0.9, 0.9);
				bg.antialiasing = true;
				bg.scrollFactor.set(0.9, 0.7);
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('funfarmhouse_night', 150, 250, 0.9, 0.9);
				bg.antialiasing = true;
				bg.scrollFactor.set(1.1, 0.9);
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('grass lands_night', -400, 600, 0.9, 0.9);
				bg.antialiasing = true;
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('Cornys_night', -350, 325, 0.9, 0.9);
				bg.antialiasing = true;			
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('Cornys_night', 1050, 325, 0.9, 0.9);
				bg.antialiasing = true;
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('crazy fences_night', -350, 450, 0.9, 0.9);
				bg.antialiasing = true;
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('Sign_night', 0, 500, 0.9, 0.9);
				bg.antialiasing = true;
				bg.active = false;
				add(bg);

                case 'bambisFarm-sunset': //Week Maze
				var bg:BGSprite = new BGSprite('sky_sunset', -600, -200, 0.9, 0.9);
				bg.antialiasing = true;
				bg.scrollFactor.set(0.75, 0.75);
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('orangey hills_sunset', -250, 200, 0.9, 0.9);
				bg.antialiasing = true;
				bg.scrollFactor.set(0.9, 0.7);
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('funfarmhouse_sunset', 150, 250, 0.9, 0.9);
				bg.antialiasing = true;
				bg.scrollFactor.set(1.1, 0.9);
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('grass lands_sunset', -400, 600, 0.9, 0.9);
				bg.antialiasing = true;
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('Cornys_sunset', -350, 325, 0.9, 0.9);
				bg.antialiasing = true;			
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('Cornys_sunset', 1050, 325, 0.9, 0.9);
				bg.antialiasing = true;
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('crazy fences_sunset', -350, 450, 0.9, 0.9);
				bg.antialiasing = true;
				bg.active = false;
				add(bg);

				var bg:BGSprite = new BGSprite('Sign_sunset', 0, 500, 0.9, 0.9);
				bg.antialiasing = true;
				bg.active = false;
				add(bg);

                case 'green-void': //Week Cheater
				var bg:BGSprite = new BGSprite('cheater', -600, -200, 0.9, 0.9);
				bg.antialiasing = true;
				bg.scrollFactor.set(0.75, 0.75);
				bg.active = false;
				add(bg);
	...
	public function endSong():Void
	{
		...
		if(achievementObj != null) {
			...
			var achieve:String = checkForAchievement(['week1_nomiss', 'week2_nomiss', 'week3_nomiss', 'week4_nomiss',
				'week5_nomiss', 'week6_nomiss', 'week7_nomiss', 'weekdave_nomiss', 'weekxxx_nomiss', 'weeky_nomiss', 'weekzzz_nomiss']);
	...
	private function checkForAchievement(achievesToCheck:Array<String>):String {
		for (i in 0...achievesToCheck.length) {
			...
			if(!Achievements.isAchievementUnlocked(achievementName)) {
				...
				{
					case 'week1_nomiss' | 'week2_nomiss' | 'week3_nomiss' | 'week4_nomiss' | 'week5_nomiss' | 'week6_nomiss' | 'week7_nomiss' | 'weekdave_nomiss' | 'weekxxx_nomiss' | 'weeky_nomiss' | 'weekzzz_nomiss':
						if(isStoryMode && campaignMisses + songMisses < 1 && CoolUtil.difficultyString() == 'HARD' && storyPlaylist.length <= 1 && !changedDifficulty && !usedPractice)
						{
							...
							switch(weekName) //I know this is a lot of duplicated code, but it's easier readable and you can add weeks with different names than the achievement tag
							{
								...
								case 'weekdave':
									if(achievementName == 'weekdave_nomiss') unlock = true;
								case 'weekxxx':
									if(achievementName == 'weekxxx_nomiss') unlock = true;
								case 'weeky':
									if(achievementName == 'weeky_nomiss') unlock = true;
								case 'weekzzz':
									if(achievementName == 'weekzzz_nomiss') unlock = true;
							}
						}
					case 'ur_bad':
